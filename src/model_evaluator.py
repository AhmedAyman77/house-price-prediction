...
class ModelEvaluationStrategy(ABC):
    @abstractmethod
    def evaluation_model(self, model: RegressorMixin, X_test: pd.DataFrame, y_test: pd.Series) -> dict:
        pass
...
class ModelEvaluator:
    def __init__(self, strategy: ModelEvaluationStrategy) -> None:
        self.strategy = strategy
    
    def det_strategy(self, strategy: ModelEvaluationStrategy):
    ...
    def evaluate(self, model: RegressorMixin, X_test: pd.DataFrame, y_test: pd.Series) -> dict:
        ...
        return self._strategy.evaluation_model(model, X_test, y_test)
